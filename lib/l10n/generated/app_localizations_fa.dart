...
class AonL10nFa extends AonL10n {
  ...
  String get webPrivacyStorageBody =>
      'برنامهٔ ذخیره‌شده (شب من)، مهرهای گذرنامهٔ نجوم، مکان‌های موردعلاقه، زبان و پوستهٔ انتخابی شما، و این‌که آیا با بارگذاری نقشهٔ گوگل موافقت کرده‌اید، به‌صورت محلی در مرورگر شما ذخیره می‌شود. این اطلاعات در همین مرورگر و روی این دستگاه می‌ماند — ما سروری نداریم و آن را نمی‌بینیم. پاک‌کردن دادهٔ این سایت در مرورگر، یا گزینهٔ «حذف داده‌های من» در تنظیمات، آن را حذف می‌کند.';
  ...
  String get webPrivacyContactBody =>
      'برای کمک یا پرسش‌های حریم خصوصی، از اطلاعات پشتیبانی و تماس در وب‌سایت رسمی رویداد Astronomy Open Night استفاده کنید.';
