...
class AonL10nFa extends AonL10n {
  ...
  String get settingsPrivacyBody =>
      'برنامه حساب کاربری یا تبلیغات ندارد. مهرها، علاقه‌مندی‌ها، برنامه و تنظیمات محلی هستند؛ ممکن است در نسخهٔ پشتیبان اندروید قرار بگیرند.\n\nتصاویر دوربین روی دستگاه می‌مانند. در اندروید، Google ML Kit گزارش‌های فنی و استفاده و شناسه‌های نصب را ارسال می‌کند.\n\nموقعیت برای نقشهٔ پردیس و قطب‌نما استفاده می‌شود. پس از موافقت شما، مسیر پیاده‌روی مبدأ و مقصد را به گوگل می‌فرستد. نقشهٔ گوگل اطلاعات فنی، شناسه‌ها، گزارش خطا و تعامل با نقشه را نیز جمع‌آوری می‌کند.\n\nجزئیات، نگهداری، حذف و اطلاعات تماس را در سیاست حریم خصوصی زیر بخوانید.';
  ...
  String get settingsPrivacyPolicyBody =>
      'Astronomy Open Night یک اپلیکیشن مستقلِ همراهِ رویداد است که توسط Leo Alavi و Mohammad Raouf Abedini برای Astronomy Night – FSE Outreach Team توسعه یافته و تحت حساب توسعه‌دهندهٔ Leo Alavi منتشر می‌شود. تماس دربارهٔ حریم خصوصی: leo@leoalavi.dev. آخرین به‌روزرسانی: ۱۰ سپتامبر ۲۰۲۶.\n\nبرنامه حساب کاربری، ورود، تبلیغات یا سامانهٔ تحلیل تحت مدیریت توسعه‌دهنده ندارد. مهرهای گذرنامه، علاقه‌مندی‌ها، برنامهٔ ذخیره‌شده و تنظیمات به‌صورت محلی ذخیره می‌شوند. اندروید ممکن است طبق تنظیمات دستگاه، این داده‌ها را در نسخهٔ پشتیبان یا انتقال به دستگاه دیگر قرار دهد.\n\nموقعیت مکانی اختیاری است و برای نقشهٔ پردیس و قطب‌نما روی دستگاه پردازش می‌شود. وقتی مسیر پیاده‌روی می‌خواهید و با استفاده از نقشهٔ گوگل موافقت می‌کنید، مبدأ مسیر (که ممکن است موقعیت دقیق یا تقریبی شما باشد) و مقصد از طریق HTTPS به گوگل ارسال می‌شوند.\n\nنقشهٔ گوگل برای ارائه و بهبود خدمات، درخواست‌های نقشه، نشانی IP، اطلاعات دستگاه و برنامه، شناسهٔ مخصوص SDK، گزارش‌های خطا و تعامل با نقشه را نیز دریافت می‌کند. هیچ نقشهٔ گوگلی پیش از موافقت شما بارگذاری نمی‌شود و می‌توانید این اجازه را در تنظیمات لغو کنید.\n\nدر اندروید، اسکنر QR از Google ML Kit استفاده می‌کند. تصاویر دوربین روی دستگاه پردازش می‌شوند و برنامه آن‌ها را ذخیره یا ارسال نمی‌کند. ML Kit اطلاعات دستگاه و برنامه، شناسه‌های نصب و گزارش‌های عملکرد و استفاده را از طریق HTTPS به گوگل می‌فرستد. می‌توانید به‌جای دوربین، کد چاپ‌شدهٔ ایستگاه را وارد کنید.\n\nمهرها، علاقه‌مندی‌ها و برنامهٔ ذخیره‌شده تا زمان حذف باقی می‌مانند. گزینهٔ «حذف داده‌های من» در تنظیمات این موارد و رضایت استفاده از نقشهٔ گوگل را پاک می‌کند؛ زبان و تنظیمات ظاهری باقی می‌مانند. این کار داده‌هایی را که قبلاً به گوگل رسیده یا در نسخه‌های پشتیبان هستند حذف نمی‌کند. نگهداری و حذف داده‌های خدمات گوگل تابع سیاست حریم خصوصی گوگل است که پیوند آن در بخش حریم خصوصی نقشهٔ گوگل در پایین قرار دارد.\n\nما سروری برای نگهداری برنامهٔ ذخیره‌شده یا مهرهای شما نداریم. داده‌های محلی در فضای اختصاصی برنامه در اندروید ذخیره می‌شوند؛ امنیت مطلق تضمین نمی‌شود. برای پرسش‌های حریم خصوصی با نشانی بالا تماس بگیرید. این سیاست همهٔ بازدیدکنندگان را پوشش می‌دهد.';
  ...
  String webPrivacyIntro(String developer, String forTeam) {
    return 'این اطلاعیهٔ حریم خصوصی برای نسخهٔ وب برنامهٔ Astronomy Open Night 2026 است. این برنامه حساب کاربری و ورود ندارد و کاملاً در مرورگر شما اجرا می‌شود. این سیاست حریم خصوصی برای برنامهٔ Astronomy Open Night 2026 است — هم این نسخهٔ وب و هم اپلیکیشن موبایل. این یک اپلیکیشن همراهِ رویداد است که توسط $developer برای $forTeam توسعه یافته و حساب کاربری یا ورود ندارد. اطلاعات و پشتیبانی رسمی رویداد از طریق وب‌سایت رسمی رویداد ارائه می‌شود.';
  }
  ...
  String get webPrivacyStorageBody =>
      'برنامهٔ ذخیره‌شده (شب من)، مهرهای گذرنامهٔ نجوم، مکان‌های موردعلاقه، زبان و پوستهٔ انتخابی شما، و این‌که آیا با بارگذاری نقشهٔ گوگل موافقت کرده‌اید، روی دستگاه شما ذخیره می‌شود — در مرورگر شما در نسخهٔ وب، یا در حافظهٔ محلی اپلیکیشن موبایل. این اطلاعات روی دستگاه شما می‌ماند؛ ما سروری نداریم و آن را نمی‌بینیم. در موبایل، نسخه‌های پشتیبان دستگاه شما (iCloud در iOS، پشتیبان‌گیری سیستمی در اندروید) ممکن است طبق تنظیمات دستگاه شامل آن شود. پاک‌کردن دادهٔ این سایت، گزینهٔ «حذف داده‌های من» در تنظیمات، یا حذف اپلیکیشن موبایل آن را حذف می‌کند.';
  ...
  String get webPrivacyLocationBody =>
      'نقشهٔ پردیس بدون موقعیت مکانی هم کار می‌کند. اگر اجازه دهید، موقعیت شما روی دستگاه برای نمایش جای شما روی نقشه استفاده می‌شود — و در اپلیکیشن موبایل، برای جهت‌دهی قطب‌نما به‌سوی یک مکان با استفاده از حسگر حرکت دستگاه که هرگز از دستگاه خارج نمی‌شود. این برای ما ارسال نمی‌شود و ذخیره نمی‌گردد. اگر اجازه ندهید، نقشه باز هم کار می‌کند.';
  ...
  String get webPrivacyCameraBody =>
      'گذرنامهٔ نجوم در هر مکان از یک کد کوتاه استفاده می‌کند. در اپلیکیشن موبایل می‌توانید کد QR مکان را با دوربین اسکن کنید: تصاویر روی دستگاه پردازش می‌شوند و هرگز ذخیره یا بارگذاری نمی‌شوند، و در اندروید اسکنر از Google ML Kit استفاده می‌کند که اطلاعات دستگاه و برنامه، شناسه‌های نصب و گزارش‌های تشخیصی را به گوگل می‌فرستد. همیشه می‌توانید به‌جای آن کد چاپ‌شده را وارد کنید — و نسخهٔ وب فقط از همین ورود دستی کد استفاده می‌کند و دوربین را باز نمی‌کند.';
  ...
  String get webPrivacyAnalyticsBody =>
      'این برنامه هیچ ابزار تحلیل، تبلیغات، پیکسل ردیابی یا ردیاب شخص ثالث ندارد و هیچ کوکی‌ای برای شناسایی شما تنظیم نمی‌کند. تنها شخص ثالث درگیر گوگل است، آن هم فقط برای نقشه و مسیری که بالا توضیح داده شد، و فقط پس از موافقت شما. ما داده‌های شخصی شما را نمی‌فروشیم.';
  ...
  String get webPrivacyRetentionBody =>
      'چون همه چیز روی دستگاه شما ذخیره می‌شود، تا زمانی که آن را حذف نکنید باقی می‌ماند. تنظیمات ← حذف داده‌های من، برنامهٔ ذخیره‌شده، مهرها، علاقه‌مندی‌ها و رضایت نقشهٔ گوگل را پاک می‌کند؛ زبان و تنظیمات ظاهری حفظ می‌شوند. این کار داده‌هایی را که پیش‌تر به گوگل رسیده یا در نسخه‌های پشتیبان دستگاه است حذف نمی‌کند.';
  ...
  String get webPrivacyContactBody =>
      'برای پرسش‌های حریم خصوصی با توسعه‌دهندگان، Leo Alavi و Mohammad Raouf Abedini، به نشانی leo@leoalavi.dev تماس بگیرید. برای اطلاعات و پشتیبانی رویداد، از وب‌سایت رسمی رویداد Astronomy Open Night یا astronomyopennight@mq.edu.au استفاده کنید.';
