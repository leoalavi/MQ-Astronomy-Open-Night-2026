...
class AonL10nFa extends AonL10n {
  ...
  String get webPrivacyContactBody =>
      'برای کمک یا پرسش‌های حریم خصوصی، با astronomyopennight@mq.edu.au تماس بگیرید، یا از اطلاعات پشتیبانی و تماس در وب‌سایت رسمی رویداد Astronomy Open Night استفاده کنید.';
