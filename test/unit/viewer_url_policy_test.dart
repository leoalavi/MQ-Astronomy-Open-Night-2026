...
void main() {
  ...
  test('rejects everything else, by parsed parts not prefix', () {
    for (final u in [
      'http://localhost:8459/data/indoor/x.jpg', 'http://localhost:8459/', 'about:srcdoc',
      'https://localhost:8459/web/indoor_viewer.html', 'http://localhost:8460/web/indoor_viewer.html',
      'http://localhost.evil.example/web/indoor_viewer.html', 'http://127.0.0.1:8459/web/indoor_viewer.html',
